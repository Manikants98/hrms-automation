...
interface ImportHiringStageProps {
  drawerOpen: boolean;
...
const ImportHiringStage: React.FC<ImportHiringStageProps> = ({
  drawerOpen,
  setDrawerOpen,
}) => {
  ...
  const handleDownloadSample = async () => {
    try {
      await downloadTemplateMutation.mutateAsync('hiring_stages');
    } catch (error) {
        ...
        <form onSubmit={formik.handleSubmit} className="!space-y-6">
          <Alert severity="info" className="!mb-4">
            <Typography variant="body2">
              Upload an Excel file to import multiple hiring stages. Download
...
export default ImportHiringStage;
