...
interface ImportLeaveApplicationProps {
  drawerOpen: boolean;
...
const ImportLeaveApplication: React.FC<ImportLeaveApplicationProps> = ({
  drawerOpen,
  setDrawerOpen,
}) => {
  ...
  const handleDownloadSample = async () => {
    try {
      await downloadTemplateMutation.mutateAsync('leave_applications');
    } catch (error) {
        ...
        <form onSubmit={formik.handleSubmit} className="!space-y-6">
          <Alert severity="info" className="!mb-4">
            <Typography variant="body2">
              Upload an Excel file to import multiple leave applications.
...
export default ImportLeaveApplication;
