...
interface ImportLeaveBalanceProps {
  drawerOpen: boolean;
...
const ImportLeaveBalance: React.FC<ImportLeaveBalanceProps> = ({
  drawerOpen,
  setDrawerOpen,
}) => {
  ...
  const handleDownloadSample = async () => {
    try {
      await downloadTemplateMutation.mutateAsync('leave_balances');
    } catch (error) {
        ...
        <form onSubmit={formik.handleSubmit} className="!space-y-6">
          <Alert severity="info" className="!mb-4">
            <Typography variant="body2">
              Upload an Excel file to import multiple leave balances. Download
...
export default ImportLeaveBalance;
